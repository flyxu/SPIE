...
nb_train_samples = 56991
nb_validation_samples = 24624
nb_test_samples = 18 
nb_epoch = 25
...
def train_top_model():
    ...
    train_labels = np.array([0] * 45759 + [1] * 11232)

    validation_data = np.load(open('bottleneck_features_validation.npy', 'rb'))
    validation_labels = np.array([0] * 20304 + [1] * 4320)
